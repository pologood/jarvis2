...
public final class WriteLogProtos {
  ...
  public static final class LogStorageWriteLogResponse extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.mogujie.jarvis.protocol.WriteLogProtos.internal_static_LogStorageWriteLogResponse_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.mogujie.jarvis.protocol.WriteLogProtos.internal_static_LogStorageWriteLogResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse.class, com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse.Builder.class);
    }
    ...
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseFrom(
    ...
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseFrom(
    ...
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.mogujie.jarvis.protocol.WriteLogProtos.internal_static_LogStorageWriteLogResponse_descriptor;
      }
      ...
      // Construct using com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse getDefaultInstanceForType() {
        return com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse.getDefaultInstance();
      }

      public com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse build() {
        com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse buildPartial() {
        com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse result = new com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse) {
          return mergeFrom((com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse other) {
        if (other == com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse.getDefaultInstance()) return this;
        if (other.hasSuccess()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.mogujie.jarvis.protocol.WriteLogProtos.LogStorageWriteLogResponse) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
