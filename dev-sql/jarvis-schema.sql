...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='app表';
...
CREATE TABLE `job` (
  ...
  `isSerial` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否并行',
...
) ENGINE=InnoDB AUTO_INCREMENT=9009 DEFAULT CHARSET=utf8 COMMENT='job表';
...
CREATE TABLE `operation_log` (
  ...
  `opeDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=15229 DEFAULT CHARSET=utf8 COMMENT='task表';
