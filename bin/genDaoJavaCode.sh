...
java -cp ${BIN_PATH}/mybatis-generator-core-1.3.3-SNAPSHOT.jar:${BIN_PATH}/mysql-connector-java-5.1.37.jar  org.mybatis.generator.api.ShellRunner -configfile ${MYBATIS_CONFIG_FILE} -overwrite -verbose
